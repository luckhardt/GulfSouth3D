        ...
        <div>
            ...
            <div className="quote-band">
                <blockquote className="quote-band-text">
                    "Time eats away at things: it rusts machinery, it matures animals to become hairless and featherless, and it withers plants."
                </blockquote>
                <p className="quote-band-attribution">Jesmyn Ward, Sing, Unburied, Sing</p>
            </div>
            ...
            <div className="stories-section">
                <div className="stories-section-inner">
                    ...
                    <div className="stories-section-quote">
                        <p>"My work to fill in the blanks, the absences, the omissions… the narratives I seek to restore have been there all along."</p>
                        <span>— Natasha Trethewey, "You Are Not Safe in Science; You Are Not Safe in History"</span>
                    </div>
                </div>
            </div>
            ...
            <div className="quote-band">
                ...
                <p className="quote-band-attribution">Natasha Trethewey, "Liturgy, For the Mississippi Gulf Coast"</p>
            </div>
            ...
            <div className="stories-section">
                <div className="stories-section-inner">
                    ...
                    <p>
                        Public and decorative arts show a different side of how values are made visible. The painted utility boxes and murals in Hattiesburg, like the All That Jazz utility box or the Koi Across the World mural, were not built as formal institutions. They belong instead to the visual life of everyday places: routes, corners, and public-facing spaces. Their meaning comes from placement, design, and encounter, including what people notice or just pass by.
                    </p>
                    <p>
            ...
            <div className="quote-band">
                ...
                <p className="quote-band-attribution">Eudora Welty, "Place in Fiction"</p>
            </div>
            ...
            <div className="stories-section">
                <div className="stories-section-inner">
                    ...
                    <p>
                        Some objects and places matter because they show how South Mississippi connects to larger histories. The pre-World War II gas mask connects local collections to military service and global conflict. The Eureka School in Hattiesburg opens stories about Black education and community life. Projectile points connect us to Indigenous histories and deep time, showing material traces that long predate written records.
                    </p>
                    <p>
                        Houses of worship like Our Lady of the Gulf Catholic Church in Bay St. Louis and Temple B'nai Israel in Hattiesburg show how civic and religious identity took shape in specific communities. The Seymour the Golden Eagle whiskey decanter connects university culture to pride and institutional belonging.
                    </p>
                    <p>
                        Studied together, these objects and places show that regional history is not small history. A uniform, a school, a church, a projectile point, a decanter, or an auditorium begins in one place, but each one reaches outward. They show how national and global events were lived locally, how communities built institutions in response to larger forces, and how South Mississippi's histories can help us understand broader patterns of war, education, faith, Indigenous presence, public life, and belonging.
                    </p>
                </div>
            </div>
